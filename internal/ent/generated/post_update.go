...
func (pu *PostUpdate) defaults() error {
	if _, ok := pu.mutation.UpdatedAt(); !ok {
		if post.UpdateDefaultUpdatedAt == nil {
			return fmt.Errorf("generated: uninitialized post.UpdateDefaultUpdatedAt (forgotten import generated/runtime?)")
		}
...
func (pu *PostUpdate) check() error {
	...
	if pu.mutation.OwnerCleared() && len(pu.mutation.OwnerIDs()) > 0 {
		return errors.New(`generated: clearing a required unique edge "Post.owner"`)
	}
	return nil
}
...
func (pu *PostUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if pu.mutation.DeletedByCleared() {
		_spec.ClearField(post.FieldDeletedBy, field.TypeString)
	}
...
func (puo *PostUpdateOne) sqlSave(ctx context.Context) (_node *Post, err error) {
	...
	if !ok {
		return nil, &ValidationError{Name: "id", err: errors.New(`generated: missing "Post.id" for update`)}
	}
