...
type ApiKeyFunc func(context.Context, *generated.ApiKeyMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f ApiKeyFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.ApiKeyMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.ApiKeyMutation", m)
}
...
type PostFunc func(context.Context, *generated.PostMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f PostFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.PostMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.PostMutation", m)
}

// The PostCategoryFunc type is an adapter to allow the use of ordinary
// function as PostCategory mutator.
type PostCategoryFunc func(context.Context, *generated.PostCategoryMutation) (generated.Value, error)

// Mutate calls f(ctx, m).
func (f PostCategoryFunc) Mutate(ctx context.Context, m generated.Mutation) (generated.Value, error) {
	if mv, ok := m.(*generated.PostCategoryMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *generated.PostCategoryMutation", m)
}
