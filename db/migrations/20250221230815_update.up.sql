...
CREATE INDEX "comment_owner_id" ON "comments"("owner_id")
WHERE
  deleted_at IS NULL;
...
CREATE INDEX "post_owner_id" ON "posts"("owner_id")
WHERE
  deleted_at IS NULL;

-- create index "post_title" to table: "posts"
CREATE INDEX "post_title" ON "posts" USING GIN("title");
