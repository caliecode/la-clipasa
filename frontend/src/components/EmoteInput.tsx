...
const createEmoteImgHtml = (key: string, src: string): string => {
  return `<img src="${src}" alt="${key}" title="${key}" data-emote="true" contenteditable="false" style="width: ${EMOTE_IMG_SIZE}px; height: ${EMOTE_IMG_SIZE}px; vertical-align: middle; margin: 0 1px;" />​`
}
